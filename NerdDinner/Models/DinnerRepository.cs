...
namespace NerdDinner.Models
{
    ...
    public class DinnerRepository : NerdDinner.Models.IDinnerRepository
    {
        ...
        NerdDinnerEntities db = new NerdDinnerEntities(ConnectionStringResolver
                                                            .Create()
                                                            .WithCloudConnectionStringName("DataConnectionString")
                                                            .WithLocalConnectionStringName("NerdDinnerEntities")
                                                            .ConnectionString);
